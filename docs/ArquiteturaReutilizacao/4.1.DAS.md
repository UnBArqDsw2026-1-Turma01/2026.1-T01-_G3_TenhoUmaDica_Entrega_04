...
Autores: Gabriel Araújo, João Ramos
...
As estimativas do projeto foram produzidas de forma independente pelos integrantes e, em seguida, consolidadas em discussão técnica de consenso, seguindo os passos do método Wideband Delphi: coleta anônima individual, análise de divergências e convergência para um valor final. Os insumos utilizados foram os resultados do Brainstorm e o Rich Picture produzidos na Entrega 01.

Em termos de escopo funcional (que inicialmente previa entre 25 e 35 funcionalidades mapeadas), o refinamento do sistema para a fase de MVP, detalhado na Entrega 02, consolidou o escopo final em exatas 36 Histórias de Usuário (US) e 4 Requisitos Não Funcionais (RNF), estruturados em 15 épicos de desenvolvimento. Essas funcionalidades estão distribuídas em aproximadamente 15 telas principais com variações de estado e perfil de acesso.
...
O custo operacional estimado para a fase de validação é de R$ 0, viabilizado pela escolha do Firebase no plano gratuito (Spark) como infraestrutura de persistência, autenticação e hospedagem de dados. Essa restrição econômica teve um impacto direto na arquitetura do projeto. Por causa dela, a equipe precisou descartar o uso de servidores dedicados, banco de dados relacional próprio e qualquer serviço de terceiro pago. Isso justifica e reforça a decisão, já detalhada na Seção 3.2, de abandonar a stack inicial de PostgreSQL com Prisma (planejada no 5W2H da Entrega 01) e adotar integralmente o Firebase.

A tabela a seguir apresenta os dados brutos da avaliação individual e a convergência aprovada pelo grupo:

| Categoria | Métrica | Pessoa A | Pessoa B | Pessoa C | Pessoa D | Valor Final (Consenso) |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Tamanho** | Histórias de usuário | 20 a 30 | 22 | 20 | 25 | **25–35 (Fechado em 36 US)** |
| **Esforço** | Dedicação diária | 1.5h | 2h | 2h | 2h | **2 horas / dia útil** |
| **Custo Operacional** | Servidores / Cloud | R$ 0 | R$ 0 | R$ 0 | R$ 0 a 25 | **R$ 0 no MVP (Firebase)** |
| **Cronograma** | Sprints semanais | 8 | 8 | 10 | 8 | **8 sprints** |
| **Custo Dev** | Valor-hora estimado | R$ 800 | R$ 800 | R$ 800 | R$ 30k–40k | **R$ 800 (Projeto Acadêmico)** |

*Fonte: [Artefato de Estimativas da Entrega 01](https://unbarqdsw2026-1-turma01.github.io/2026.1-T01-_G3_TenhoUmaDica_Entrega_01/#/Base/1.2.ArtefatoGeneralista) (Angélica, João Gabriel, João Reis e Brenda, 2026).*
...
| 21/06/2026 | 1.9 | Adição de Tamanho e Desempenho | João Ramos |
| 21/06/2026 | 2.0 | Atualizção de Tamanho e Desempenho | João Ramos |
